...
function createUser($title){
	DB::exec("insert into users (title) values ('$title')");
}
function createContent($content){
	DB::exec("insert into users (content) values ('$content')");
}
...
DB::exec("INSERT INTO `users`(title,content) VALUES ('$title' , '$content')");
